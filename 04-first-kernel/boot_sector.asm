...
; --- gdt and routines ----------------------
%include "routines/gdt.asm"         ; defining global descriptor table
%include "routines/print.asm"       ; printing in 16bit real mode
%include "routines/print_hex.asm"   ; printing hex values in 16bit real mode
%include "routines/read_disk.asm"   ; reading disk sectors with BIOS calls
%include "routines/print_vga.asm"   ; printing in 32bit protected mode
%include "routines/switch_pm.asm"   ; switching to 32 bit protected mode
